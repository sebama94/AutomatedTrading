...
// Input parameters
//input 
int InpInputNeurons = 32;     // Number of input neurons (features)
int InpHiddenNeurons1 = 256;   // Number of neurons in first hidden layer
int InpHiddenNeurons2 = 128;   // Number of neurons in second hidden layer
int InpHiddenNeurons3 = 64;   // Number of neurons in second hidden layer
int InpHiddenNeurons4 = 16;   // Number of neurons in second hidden layer
...
{
   EventSetTimer(60*30);
   int layers[] = {InpInputNeurons, InpHiddenNeurons1, InpHiddenNeurons2, InpHiddenNeurons3, InpHiddenNeurons4,InpHiddenNeurons5, InpOutputNeurons};
